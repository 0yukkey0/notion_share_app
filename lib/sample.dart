          ...
          child: Column(
            children: <Widget>[
              ...
              MultiSelectBottomSheetField<Animal?>(
                ...
                maxChildSize: 0.95,
                title: Text("Animals"),
                buttonText: Text("Favorite Animals3"),
                items: _items,
                searchable: true,
                validator: (values) {
              ...
              MultiSelectChipField(
                ...
                selectedTextStyle: TextStyle(color: Colors.blue.shade800),
                onTap: (values) {
